...
Creation of account and logging in is an important scenario that is not part of the test. 
Also the check out functionality and empty cart. It is also good to rerun all the scenario when the user is logged in.

2. Jupiter Toys is expected to grow and expand its offering into books, tech, and modern art. We are expecting the of tests will grow to a very large number. What approaches could you used to reduce overall execution time? 
